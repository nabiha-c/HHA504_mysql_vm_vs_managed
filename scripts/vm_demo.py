# vm_demo.py — simplified, fixed version for GCP VM
import os, time
...
# --- 0) Load environment ---
load_dotenv(".env")  # Make sure .env is in repo root
...
# --- 1) Connect to MySQL server (NO DB in URL) ---
...
# --- 3) Create a DataFrame and write it to the table ---
table_name = "visits"
df = pd.DataFrame(
    [
